...
const mockWithdrawalRequests = [
  {
    ...
    userName: "John Doe",
    amount: 3000,
    accountDetails: "Bank of India - 1234567890",
    ifsc: "BOI0001234",
    status: "pending",
  ...
  },
  {
    ...
    amount: 1500,
    accountDetails: "State Bank of India - 9876543210",
    ifsc: "SBIN0001234",
    status: "pending",
  ...
  },
  {
    ...
    amount: 7000,
    accountDetails: "UPI ID: michael@upi",
    ifsc: "-",
    status: "approved",
  ...
  },
  {
    ...
    amount: 4000,
    accountDetails: "HDFC Bank - 5678901234",
    ifsc: "HDFC0001234",
    status: "rejected",
...
const AdminWithdrawalRequests = () => {
  ...
  const filteredRequests = requests.filter(request => {
    const matchesSearch = 
      ...
      request.accountDetails.toLowerCase().includes(searchTerm.toLowerCase()) ||
      request.ifsc.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  const handleStatusChange = (requestId: string, newStatus: RequestStatus) => {
    ...
    toast({
      title: `Withdrawal Request ${newStatus === "approved" ? "Approved" : "Rejected"}`,
            ...
            <CardContent className="space-y-4">
              <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-1">
                  ...
                  <Input 
                    type="text" 
                    placeholder="Search by user or account details..." 
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-white/10 hover:bg-white/5">
                    ...
                    <TableHead className="text-white/70">IFSC</TableHead>
            ...
            <DialogContent className="bg-white/5 border-white/10 text-white">
              <DialogHeader>
                ...
                <DialogDescription className="text-white/70">
                  Are you sure you want to approve this withdrawal request from {selectedRequest?.userName} for ₹{selectedRequest?.amount.toLocaleString()}?
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <p className="text-sm text-white/70">Account Details</p>
                    <p className="font-medium">{selectedRequest?.accountDetails}</p>
                  </div>
                  <div>
                    <p className="text-sm text-white/70">IFSC</p>
                    <p className="font-mono text-xs">{selectedRequest?.ifsc}</p>
                  </div>
                </div>
                <div>
                  <label htmlFor="transaction-id" className="block text-sm text-white/70 mb-1">
          ...
          <Dialog open={showRejectDialog} onOpenChange={setShowRejectDialog}>
            <DialogContent className="bg-white/5 border-white/10 text-white">
              <DialogHeader>
                ...
                <DialogDescription className="text-white/70">
                  Are you sure you want to reject this withdrawal request from {selectedRequest?.userName} for ₹{selectedRequest?.amount.toLocaleString()}?
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="grid grid-cols-2 gap-4">
